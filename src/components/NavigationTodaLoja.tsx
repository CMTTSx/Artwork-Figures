...
//Import Icons
import todaLojaWhiteVersion from '../assets/toda_loja_WhiteVersion.png';
...
export default function Navigation() {
    ...
    return (
      ...
      <Link href='/'><Button fullWidth={true} sx={{backgroundColor: '#000', '&:hover' :{backgroundColor: '#1C3144'}}}><Image src={todaLojaWhiteVersion} alt='todaLojaWhiteVersion' width={150} height={100} /></Button></Link>
