...
import carrinhoTag from '../../assets/Carrinho_icon.png'
...
export default function Main() {
  ...
  return (
    ...
    <div className='CardProdutos'>
        ...
        <div className='tags'>
          <img className='favoritotag' src={coracaoIcon} alt="tagFavorito" />
          <img className='compartilharTag' src={carrinhoTag} alt="tagCompartilhar" />
        </div>
      ...
      <div className='descricao'>
        ...
        <button className='AddButton'>ADICIONAR AO CARRINHO</button>
